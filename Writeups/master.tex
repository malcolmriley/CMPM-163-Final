...
\authornote{Explosion Particle Effects}
\email{amedin12@ucsc.edu}
\ucscaffil

\author{Jan Yu}
\authornote{House Dissolve Effect}
\email{jyu92@ucsc.edu}
\ucscaffil

\author{Malcolm Riley}
\authornote{3D Models, Energy Weapon VFX, Hover VFX, Main Scene Assembly, Documentation}
...
\begin{teaserfigure}
	...
	\caption{Scene View}
	\Description{Main view of project scene.}
\end{teaserfigure}
